    ...
    $(function() {
        ...
        if ( !WebUploader.Uploader.support('flash') && WebUploader.browser.ie ) {
            ...
            // 压根就没有安转。
                ...
                $wrap.html('<a href="http://www.adobe.com/go/getflashplayer" target="_blank" border="0"><img alt="get flash player" src="Public/Admin/http://www.adobe.com/macromedia/style_guide/images/160x41_Get_Flash_Player.jpg" /></a>');
            }
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('lib/webuploader/0.1.5/server/preview.php', {
                            ...
                            if (response.result) {
                                img = $('<img src="Public/Admin/'+response.result+'">');
                                $wrap.empty().append( img );
                            } else {
                                $wrap.text("预览出错");
                            }
