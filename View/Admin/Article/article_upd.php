...
<title>新增文章 - 文章管理 - H-ui.admin v3.1</title>
	...
	<form class="form form-horizontal" action="?c=Article&a=article_Upd_do" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $value['article_title']; ?>" placeholder="" id="article_title" name="article_title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">简略标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $value['article_title2']; ?>" placeholder="" id="article_title2" name="article_title2">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $value['keywords']; ?>" placeholder="" id="keywords" name="keywords">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $value['article_author']; ?>" placeholder="" id="article_author" name="article_author">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文章来源：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $value['sources']; ?>" placeholder="" id="sources" name="sources">
			</div>
		</div>
		<div class="row cl">
